          ...
          {consultingPatient ? (
            <div className="bg-white rounded-xl border border-border-color shadow-sm flex flex-col flex-1 overflow-hidden">
              ...
              <Group orientation="horizontal" className="flex-1 flex overflow-hidden">
                ...
                <Panel defaultSize="60%" minSize="30%" className="flex flex-col justify-between bg-white overflow-hidden">
                ...
                <ResizeHandle />
                <Panel defaultSize="20%" minSize="15%" maxSize="40%" className="border-l border-border-color bg-gray-50 flex flex-col shrink-0 overflow-y-auto">
